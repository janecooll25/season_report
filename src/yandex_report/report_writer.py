...
SYSTEM_PROMPT = (
    ...
    "выдумывай данные, которых нет. В таблицах есть колонка «Изменение» — это "
    "динамика к прошлому сезону; обязательно отражай в тексте рост или снижение "
    "ключевых показателей и, где уместно, называй вероятные причины. Значение "
    "«новое» означает, что в прошлом сезоне данных не было — про такое не пиши "
    "«рост». Объём — 1–2 абзаца."
)
