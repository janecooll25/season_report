...
REC_LIBRARY: dict[str, dict[str, str]] = {
    ...
    PARAM_ONLINE: {
        "good": ("Это хороший результат, однако Клубу следует продолжать стремиться к "
                 "максимальной доле продаж билетов через интернет."),
        "ok": ("Клубу необходимо стремиться к увеличению доли продаж билетов через интернет: "
               ...
               "продаж. Маркетинговые усилия по росту интернет-продаж сокращают затраты на "
               "поддержку касс и позволяют пополнять базу болельщиков Клуба, повышая их "
               "вовлечённость и коммерческие доходы Клуба."),
        "bad": ("Доля интернет-продаж существенно ниже среднего по Лиге. Клубу необходимо "
                "предпринять маркетинговые усилия для увеличения доли продаж через интернет как "
                "основного канала: это сократит затраты на поддержку касс и позволит пополнять "
                "базу болельщиков Клуба, повышая коммерческие доходы Клуба."),
    ...
    PARAM_FREE: {
        ...
        "bad": ("Доля бесплатных билетов остаётся высокой. Клубу настоятельно рекомендуется "
                "существенно сократить бесплатное распространение и наращивать коммерческую "
                "реализацию, что повысит доходы билетной программы и заполняемость Спортсооружения."),
